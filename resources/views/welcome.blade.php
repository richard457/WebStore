...
<head>
  <link rel="stylesheet" href="{{asset('css/custom.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('custom.scss')}}">
...
<body>
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="/shop/Shoes/56"><i class="glyphicon glyphicon-lock"></i> Login</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Shop<i class="glyphicon glyphicon-chevron-up"></i></a>
                                ...
                                <li class="dropdown"><a href="#">Blog<i class="glyphicon glyphicon-chevron-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-sm-6">
                                    <h1><span>E</span>-SHOPPING WITH US</h1>
                                    <h2>Shop everything you need with us</h2>
                            ...
                            <div class="item">
                                <div class="col-sm-6">
                                    <h1><span>E</span>-SHOPPING WITH US</h1>
                                    <h2>100% Guarantee and money back</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                    <button type="button" class="btn btn-default get">Get it now</button>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="item">
                                <div class="col-sm-6">
                                    <h1><span>E</span>-SHOPPING WITH US</h1>
                                    <h2>Much of new products is here.</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                    <button type="button" class="btn btn-default get">Get it now</button>
                                </div>
                                <div class="col-sm-6">
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="#"> <span class="pull-right">(56)</span>NOKIA</a></li>
                                    <li><a href="#"> <span class="pull-right">(27)</span>GUCCI</a></li>
                                    <li><a href="#"> <span class="pull-right">(32)</span>HUAWEI</a></li>
                                    <li><a href="#"> <span class="pull-right">(5)</span>DELL</a></li>
                                    <li><a href="#"> <span class="pull-right">(9)</span>APPLE</a></li>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <a href="/shop/Shoes/56/Shoes/56" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="/shop/Shoes/56" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                            </div>
                                        </div>
                                </div>
                                <div class="choose">
                        ...
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    ...
                                    <img src="/img/sale.png" class="new" alt="" />
                                </div>
                                <div class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        <li><a href="#"><i class="fa fa-plus-square"></i>Add to wishlist</a></li>
   ...
   <script src="/js/jquery.min.js"></script>
    ...
    <script src="/js/jquery.photo.js"></script>
